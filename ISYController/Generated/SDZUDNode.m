/*
	SDZUDNode.h
	The implementation of properties and methods for the SDZUDNode object.
	Generated by SudzC.com
*/
#import "SDZUDNode.h"

#import "SDZNodeParent.h"
@implementation SDZUDNode
	...
	- (id) init
	{
		if(self = [super init])
		{
			self.address = nil;
			self.name = nil;
			self.parent = nil; // [[SDZNodeParent alloc] init];
			self.ELK_ID = nil;
	...
	+ (SDZUDNode*) newWithNode: (CXMLNode*) node
	{
		...
		return (SDZUDNode*)[[SDZUDNode alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.parent = [[SDZNodeParent newWithNode: [Soap getNode: node withName: @"parent"]] object];
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[SDZUDNode class]]) {
