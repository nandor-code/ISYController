/*
	ISYControl.h
	The implementation of properties and methods for the ISYControl object.
	Generated by SudzC.com
*/
#import "ISYControl.h"

#import "ISYActions.h"
@implementation ISYControl
	...
	+ (ISYControl*) newWithNode: (CXMLNode*) node
	{
		...
		return (ISYControl*)[[ISYControl alloc] initWithNode: node];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.actions = [[ISYActions newWithNode: [Soap getNode: node withName: @"actions"]] object];
		}
		return self;
	}
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.actions != nil && self.actions.count > 0) {
			[s appendFormat: @"<actions>%@</actions>", [ISYActions serialize: self.actions]];
		} else {
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[ISYControl class]]) {
